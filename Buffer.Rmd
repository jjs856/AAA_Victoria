...
```{r}
d <-"C:/Users/jslan/OneDrive/Documents/INTERACT/data/victoria/IBIMS_2017.shp"
sd <- shapefile(d) ## Doesn't work. Try another

getwd()
vi <- st_read("~/INTERACT/data/victoria/IBIMS_2017.shp") ## Doesn't work. FML

vi <- read_sf("C:/Users/jslan/OneDrive/Documents/INTERACT/data/victoria/IBIMS_2017.shp", quiet = TRUE, stringsAsFactors = FALSE, as_tibble = TRUE)

library(rgdal)

vi <- readOGR(dsn= paste0(getwd(),"~/INTERACT/data/victoria/IBIMS_2017.shp"))
```

# PLot Vic GPS point
```{r}

vic_int <- st_read("C:/Users/jslan/OneDrive/Documents/INTERACT/data/victoria/IBIMS_2017.shp")
st_crs(vic_int)
...
victoria_buffer = st_buffer(vic_int, dist = 70)
```
