...
vh_1 <- read_csv("/Users/dfuller/Documents/INTERACT/data/health_1vic_main_1884baf.csv") #vic health survey
ve_1 <- read_csv("/Users/dfuller/Documents/INTERACT/data/eligibility_1vic_main_1884baf.csv") #vic eligibility survey

# W2
vh_2 <- read_csv("/Users/dfuller/Documents/INTERACT/data/health_2vic_main_1884baf.csv") # w2 health n = 164
vh_2_new <- read_csv("/Users/dfuller/Documents/INTERACT/data/health_2vicnew_main_1884baf.csv") # w2 health new
ve_2 <- read_csv("/Users/dfuller/Documents/INTERACT/data/eligibility_2vic_main_1884baf.csv") # w2 eligibility
ve_2_new<- read_csv("/Users/dfuller/Documents/INTERACT/data/eligibility_2vicnew_main_1884baf.csv") # w2 new eli new n = 143
```
...
#vic_mf$income = as.numeric(as.factor(vic_mf$income))
income = as.numeric(as.factor(SD_vic_all$income))
vic_mf <- vic_mf %>% 
  rename(income = income_2)

vc <- left_join(vic_mf, SD_vic_all, .id = "interact_id") #merging health/eligibility with SD

tabyl(vic_mf$gps_checker) #checking to make sure that all of the GPS IDs transferred over correctly. 
#write_csv(vic_mf, "victoria_new_ID_gps.csv") #writing CSV
```
...
```{r}
## Age
SD_vic_two <- subset(SD_vic_two, age > 20)##Subset to remove -1s
