...
## Reading in Data
```{r}
## Do 2 files at a time. Try full_join or inner.
...
## Create new variable new and returning in w2

```{r}
# Add variable to victoria_new for new (1)

# Same for victoria_eligibility

# Add variable for vh_2 returning 2 = (1.5)

# Add variable for vh_2_new  = (2)

# Add variable for ve_2 returning = (1.5)

# Add variable for ve_2_new = (20)
```
...
# Merge w1
w1 <- full_join(victoria_new, victoria_eligibility) # Got all 281 participants, but delete the 27 duds
w1 <- w1[-(282:308),]
...
vm <- bind_rows(w2h, w2e, .id = "interact_id") #merging
