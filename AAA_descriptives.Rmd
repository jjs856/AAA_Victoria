...
## Reading in Data
```{r}
## Do 2 files at a time. 

#W1 bff188
victoria_new <- read_csv("~/INTERACT/veritas/health_1vic_main_bfd440e.csv") #vic health survey
victoria_eligibility <- read_csv("~/INTERACT/veritas/eligibility_1vic_main_bfd440e.csv") #vic eligibility survey

#W2
victoria_two <- read_csv("~/INTERACT/veritas/health_2vic_main_bfd440e.csv") # w2 health n = 164
victoria_new_two <- read_csv("~/INTERACT/veritas/health_2vicnew_main_bfd440e.csv") # w2 eli n = 123
victoria_eligibility_two <- read_csv("~/INTERACT/veritas/eligibility_2vic_main_bfd440e.csv") # w2 new health n = 173
victoria_eligibility_new_two <- read_csv("~/INTERACT/veritas/eligibility_2vicnew_main_bfd440e.csv") # w2 new eli n = 143
